# tf-azurerm-module-front_door

## Overview

This terraform module will create a front-door instance in the Azure portal along with all its optional https configuration, firewall policy and rules engine.
This module needs the following dependent modules
- tf-azurerm-module-resource_group
- tf-module-resource_name
- tf-azurerm-module-key_vault (optional to fetch the https certificates)
